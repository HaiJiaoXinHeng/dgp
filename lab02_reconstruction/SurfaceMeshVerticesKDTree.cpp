...
SurfaceMeshVerticesKDTree::~SurfaceMeshVerticesKDTree(){ if(_adapter!=nullptr) delete _adapter; }

void SurfaceMeshVerticesKDTree::build(SurfaceMesh &mesh){ 
...
//
SurfaceMesh::Vertex SurfaceMeshVerticesKDTree::closest_vertex(const Vec3 &p){
